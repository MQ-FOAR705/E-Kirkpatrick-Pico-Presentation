...
\begin{beamercolorbox}[width=1\paperwidth]{head title}
  ...
  \begin{column}[c]{1.05cm}
   %removed the following from this line:   \includegraphics[width=1cm]{figure/logo1.png}
  \end{column}
  % TITLE
  ...
  \begin{column}[c]{1.15cm}
    \hspace{0.005cm}
    %removed the following from this line:    \includegraphics[width=1cm]{figure/figure1.png}
  \end{column}
  \end{columns}
...
\textbf{Additional information:} Released under GNU General Public License v3.0. Further details can be found on github at: $https://github.com/MQ-FOAR705/E-Kirkpatrick-Pico-Presentation$
