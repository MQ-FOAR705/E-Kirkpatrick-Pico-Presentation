...
%
The image above displays the bibliographic generator which can be accessed from right-clicking a source in the Zotero library. This can then be transferred to a word publisher program which makes maintaining large bibliographies much easier and saves time.
